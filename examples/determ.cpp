...
int main()
{
    ...
    assert(addr.encoded() == "13hh3bqNwa7hySvrbrq8CGHLtmPhJRpig7");

    // ... Get the corresponding private key.
    // Extract the secret parameter.
    secret_parameter secret = wallet.generate_secret(2);
    assert(encode_hex(secret) == "8a3e04c016cc30c6fb085e9f3a76368681a57c65ebdacdcc6b61246ff4439fe3");
    ...
    // in the private key
    // assert(privkey.public_key() == pubkey); // FAIL

    // Master public key
    data_chunk mpk = wallet.master_public_key();
    assert(encode_hex(mpk) == "d996c1a50ca4a57a9dface614338a1d837cb339e08361cfaf66ffd7da8e21786");
    ...
    // assert(wallet2.generate_public_key(2) == pubkey); // FAIL
